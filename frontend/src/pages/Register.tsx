...
const Register = () => {
    ...
    return (
        <form className="flex flex-col gap-5" onSubmit={onSubmit}>
            ...
            <label className="text-gray-700 text-sm font-bold flex-1">Passowrd
                <input type="password" className="border rounded w-full py-1 px-2 font-normal" {...register("password", { required: "This field is required", minLength: { value: 6, message: "Password must be atleast 6 char" } })} />
                {errors.password && (
                    <span className="text-red-500">{errors.password.message}</span>
                )}
            </label>
            <label className="text-gray-700 text-sm font-bold flex-1">Confirm Passowrd
            ...
            <span>
                <button type="submit" className="bg-blue-600 text-white p-2 font-bold hiver:bg-blue-500 text-xl">Create Account</button>
            </span>
